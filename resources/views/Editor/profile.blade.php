            ...
            <div class="card">
                ...
                <div class="employment">
                    ...
                    <div class="employment-row">
                        <div>
                            <span style="font-weight:300;">Employee ID:</span>
                            <span style="margin-left:90px;">EMP2024801</span>
                            <span style="margin-left:250px; font-weight:300;">Position:</span>
                            <span style="margin-left:50px;"><span class="badge">Department Head</span></span>
                        </div>
                    </div>
                    <div class="employment-row">
                        <div>
