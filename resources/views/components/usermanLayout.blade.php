...
<header>
    ...
    <nav class="navbar">
        ...
        <a href="{{ route('UserManagement.manageEvents') }}"
            class="nav_item {{ request()->routeIs('UserManagement.manageEvents') ? 'active' : '' }}">
            Manage Events
        </a>
        ...
        @endphp
        <a href="{{ route('UserManagement.notifications') }}"
            class="nav_item {{ request()->routeIs('UserManagement.notifications') ? 'active' : '' }}"
        ...
        <a href="{{ route('UserManagement.eventsArchive') }}"
            class="nav_item {{ request()->routeIs('UserManagement.eventsArchive') ? 'active' : '' }}">
            Events Archive
        </a>
