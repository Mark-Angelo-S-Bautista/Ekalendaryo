<x-usermanLayout>
    ...
    <div class="edit-event-container">
        ...
        <form action="{{ route('UserManagement.updateEvent', $event->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="button-group">
                ...
                <a href="{{ isset($isRestore) && $isRestore ? route('UserManagement.eventsArchive') : route('UserManagement.manageEvents') }}"
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            const editEventForm = document.querySelector(
                'form[action^="{{ route('UserManagement.updateEvent', $event->id) }}"]');
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function checkConflict() {
                ...
                fetch("{{ route('UserManagement.checkConflict') }}", {
                        method: 'POST',
                        headers: {
            ...
            function checkUserConflict() {
                ...
                fetch("{{ route('UserManagement.checkUserConflict') }}", {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': '{{ csrf_token() }}',
