        ...
        <div class="container">
            ...
            <div class="history-columns">
                ...
                <div class="column-container">
                    ...
                    <form method="GET" action="{{ route('UserManagement.history') }}" class="history-search-form">
                        ...
                        <a href="{{ route('UserManagement.history', request()->except(['created_search', 'created_page'])) }}"
                ...
                <div class="column-container">
                    ...
                    <form method="GET" action="{{ route('UserManagement.history') }}" class="history-search-form">
                        ...
                        <button type="submit" class="history-search-btn">Search</button>
                        <a href="{{ route('UserManagement.history', request()->except(['invited_search', 'invited_page'])) }}"
                            class="history-clear-btn">Clear</a>
                    </form>
